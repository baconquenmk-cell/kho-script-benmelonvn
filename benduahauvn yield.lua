if IY_LOADED and not _G.IY_DEBUG then
	-- error("BenDuaHauVN Yield is already running!", 0)
	return
end
...
PluginsHint.Text = "Sub to BenDuaHauVN (youtube.com/@benduahuavn)"
...
CMDs[#CMDs + 1] = {NAME = 'explorer / dex', DESC = 'Opens DEX by BenDuaHauVN'}
CMDs[#CMDs + 1] = {NAME = 'olddex / odex', DESC = 'Opens Old DEX by BenDuaHauVN'}
